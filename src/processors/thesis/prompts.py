...
输出 why_it_matters 字段时严格遵循以下规则：
- why_it_matters 将用作「长期判断」模块的展示断言，会被读者逐字读到
- 必须是一句完整的中文断言，描述某个长期判断的核心观点
- 长度控制在 18-32 字之间
- 不要包含 ticker 名称、公司名、公司缩写、冒号、引号、括号
- 不要以"获得新证据支持""得到验证""持续被印证""可信度上升"等结尾或包含这些短语
- 写事实判断本身，让含义自己浮现

错误示例（以下 why_it_matters 都不合格）：
- "MSFT/NVDA AI 基础设施资本开支将持续" ❌（含 ticker）
- "AI 资本开支将持续获得新证据支持" ❌（含展示层尾句）
- "NVIDIA 数据中心业务持续增长" ❌（含公司名）
- "关于 AI 基础设施的判断获得新证据支持" ❌（模板化打勾句式）
